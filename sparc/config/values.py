...
from .interfaces import IPyContainerValue, IPyContainerValueIterator

@interface.implementer(IPyContainerValueIterator)
...
@interface.implementer(IPyContainerValue)
